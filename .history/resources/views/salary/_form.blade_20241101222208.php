<div class="card-body">
    ...
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Pilih Status Position Karyawan <span class="text-danger">*</span></label> 
        <div class="col-12 col-md-5 col-lg-5">
            <select name="status" class="form-control select2 @error('status') is-invalid @enderror">
                <option value=""></option>
                <option value="Staff" {{ "Staff" == old('status', $salary['status'] ?? '') ? 'selected' : '' }}>Karyawan</option>
