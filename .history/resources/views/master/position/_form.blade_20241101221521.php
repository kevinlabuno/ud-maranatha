<div class="card-body">
    ...
    <div class="card-header with-border pl-0 pb-1">
        <span class="col-form-label text-bold">Posisi</span>
    </div>
    <br> 
    ...
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Pendapatan</label>
    ...
    <div class="form-group row">
        ...
        <div class="col-12 col-md-5 col-lg-5">
            <select name="status" class="form-control select2 @error('status') is-invalid @enderror">
                ...
                <option value="Staff" {{ 'Staff' == old('status', $position->status ?? '') ? 'selected' : '' }}>Karyawan</option>
                <option value="Daily Worker" {{ 'Daily Worker' == old('status', $position->status ?? '') ? 'selected' : '' }}>Pekerja Harian</option>
            </select>
            @error('status')
                <span class="invalid-feedback" role="alert">
