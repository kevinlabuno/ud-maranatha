...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center mb-4 mt-4">
            {{ config('app.name', 'SIPG') }} - Sistem Pendataan dan Gaji Karyawan
            <br>
            <span style="font-weight: bold">( UD MARANATHA )</span>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-light text-center">Masuk Sistem</div>
                @if (session('message'))
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-7 offset-md-3">
                                <button type="submit" class="btn btn-dark btn-block">
                                    <i class="fa fa-unlock"></i> {{ __('Masuk') }}
                                </button>
