...
<nav class="navbar fixed-bottom footbar bg-white p-0 d-flex d-md-none" style="border-top: 1px solid rgb(222, 226, 230);">
    ...
    <div class="col text-center">
        <a href="{{ route('master.staff.index') }}" class="navbar-brand text-secondary"><i class="fas fa-user-circle"></i> <small class="d-block">Karyawan</small></a>
    </div> 
    <div class="col text-center">
...
<footer class="main-footer d-none d-md-block">
    <strong>Copyright &copy; {{ date('Y') }} <a href="#" data-toggle="tooltip" title="Lihat Situs" target="_blank">UD Maranatha</a>.</strong>
</footer>